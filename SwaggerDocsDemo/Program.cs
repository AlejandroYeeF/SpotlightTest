...
app.UseSwaggerUI(options =>
{
    ...
    "OTP Documentation v1.");
    options.RoutePrefix = string.Empty;
});
app.UseReDoc(options =>
{
    options.DocumentTitle = "OTP Documentation";
...
// escribe el archivo swagger.json o algun nombre personalizado
File.WriteAllText(currentDirectory + "/documentation_ciam_otp.json", swaggerYaml);
